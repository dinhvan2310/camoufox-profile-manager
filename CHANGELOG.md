...
### Added
- Configurable profile root directory from Settings for Web and Desktop.
- Validation for existing, writable directories and relinking of matching profile folders.
- Persistent profile-root configuration stored in the instance database.
